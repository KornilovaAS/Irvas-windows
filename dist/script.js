...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (event) {
      ...
      var formData = new FormData(item); //создаем конструктов который соберет все данные с импутов и поместит в переменную formData
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  var header = document.querySelector(headerSelector),
      ...
      content = document.querySelectorAll(contentSelector); // создаем две функции одна будет показывать нужный контент а другая скрывать 
  ...
  hideTabContent();
  showTabContent(); // использование делегирование событий чтобы отследить в какой таб кликнул пользователь

  header.addEventListener('click', function (event) {
    // т.к. часто будет использовать куда кликнул пользователь помещаем event.target в отдельную переменную
    var target = event.target; // условие проверяющее а точно ли пользователь кликнул туда куда задумано
